...
export const electricWithTwoSlice = createSlice({
        ...
        reducers: {
            ...
            calculate_D1: (state, action) => {
                ...
                state.D1 = roundPlus(action.payload.D2 * Math.exp((2 * action.payload.U) / (30 * action.payload.D2),action.payload.d2), 2)
            },
...
export const {setParametr,calculate_d, calculate_D1 } = electricWithTwoSlice.actions
