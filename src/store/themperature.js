...
export const themperatureSlice = createSlice({
    ...
    reducers: {
        ...
        calculate_La_Lm: (state, action) => {
            ...
            console.log(
                'La_Lm_вычисление___' +
                    ...
                    action.payload.Ra +
                    'valueA=' +
                    action.payload.valueA +
                    'valueM=' +
                    action.payload.valueM
            )
            if (action.payload.valueA === 'Wolframium') {
                //данные взяты из интернета (теплопроводность в Вт/см*цельсий)
                state.la = 1.63
        ...
        calculate_a_b: (state, action) => {
            ...
            const c = [
                [2, 1.429, 1.111, 0.909, 0.769], //Двумерный массив для fm и ff
        ...
        calculate_Ts: (state, action) => {
            ...
            state.Ts = roundPlus(
                action.payload.Tosn +
                    (action.payload.P *
                        (action.payload.Ha - 2 * action.payload.Ra)) /
                        (Math.PI *
                            action.payload.Ra *
                            action.payload.Ra *
                            state.la),
        ...
        calculate_Tsp: (state, action) => {
            ...
            state.Tsp = roundPlus(
                roundPlus(
                    ...
                    (action.payload.P /
                        (Math.PI * action.payload.Ra * state.lm)) *
                        state.a,
                2
            )
        },
        ...
        calculate_Pmax: (state, action) => {
            ...
            state.Pmax = roundPlus(
                ((action.payload.TfpMAX - action.payload.Tosn) *
                    Math.PI *
                    action.payload.Ra *
                    action.payload.Ra *
                    state.lm) /
