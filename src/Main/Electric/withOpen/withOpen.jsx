...
import {
    ...
    calculate_r,
    setParametr,
} from '../../../store/electricWithOpenSlice'
...
function WithOpen() {
    ...
    const { d,U, r, B, C, K } = useSelector((state) => state.electric_withOpen)
            ...
            <div className={s.content}>
                <div className={s.OneColomn}>
                    ...
                    <div className={s.item}>
                        <Tooltip
                            describeChild
                            title="B - Коэффициент, зависящий от конфигурации электродов, формы кривой напряжения и некоторых других факторов"
                        >
                            <span>B, мм/кВ</span>
                        </Tooltip>
                        <input
