...
function WithTwo () {
    ...
    const {d, D2, D1, U, C, K} = useSelector((state) => state.electric_withTwo)
    return (
        <div className={s.wrapper}>
            <div className={s.content}>
                <div className={s.OneColomn}>
                    ...
                    <div className={s.item}>
                        <span>D2, мм</span>
                        <input type="number" value={D2} onChange={(event) => dispatch(setParametr({parametr: 'D2', ref: event.target.value}))} />
                    </div>
                    <div className={s.item}>
