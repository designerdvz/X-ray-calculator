...
function Themperature() {
    ...
    useEffect(() => {
        if (!valid || invalidP || invalidHm || invalidT) {
            setIsDisabled(true)
        } else {
            setIsDisabled(false)
        }
                ...
                <div className={s.OneColomn}>
                    ...
                    {!valid && (
                        <div className={s.item}>
                            <span className={s.invalid}>
                                {' '}
                                Толщина анода должна превышать радиус анода в 2
                                раза.{' '}
                            </span>
                        </div>
                    )}
                        ...
                        <div className={s.valid}>
                            ...
                            {P > 3000 || P < 500 ? (
                                <div className={s.invalidText}>
                                    Диапазон значений мощности 500-3000Вт
                                </div>
                            ) : null}
                        </div>
                        <input
                    ...
                    <div className={s.item}>
                        <div className={s.valid}>
                            ...
                            {Hm > 0.2 || Hm < 0.05 ? (
                                <div className={s.invalidText}>
                                    Диапазон значений толщины мишени 0,05-0,2 см{' '}
                                </div>
                            ) : null}
                        </div>
                        <input
                            ...
                            onChange={(event) => {
                                ...
                                if (
                                    ...
                                    event.target.value < 0.05
                                ) {
                                    setInvalidHm(true)
                                } else setInvalidHm(false)
                            }}
                        />
                    </div>
                    <div className={s.item}>
                    ...
                    <div className={s.item}>
                        <button
                            ...
                            onClick={(event) => {
                                dispatch(
                                    calculate_La_Lm({ Ha, Ra, valueA, valueM })
                                )
